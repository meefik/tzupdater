import java.io.*;
import java.util.*;
// usage: java ZoneCompiler <setup file> <data directory> <tzdata file> <tzdata version>
//
...
public class ZoneCompactor {
  ...
  public ZoneCompactor(String setupFile, String dataDirectory, String zoneTabFile, String tzdataFile, String version) throws Exception {
    ...
    RandomAccessFile f = new RandomAccessFile(new File(tzdataFile), "rw");
    f.setLength(0);
    // Write the header.
  ...
  public static void main(String[] args) throws Exception {
    if (args.length != 5) {
      System.err.println("usage: java ZoneCompactor <setup file> <data directory> <zone.tab file> <tzdata file> <tzdata version>");
      System.exit(0);
    }
